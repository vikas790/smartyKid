...
class CustomEventBus {
  ...
  CustomEventBus.customController(StreamController controller) : _streamController = controller;
  ...
  /// Destroy this [CustomEventBus]. This is generally only in a testing context.
  ///
  void destroy() {
